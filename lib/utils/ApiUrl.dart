class ApiUrl {
  static const String BASEURL = "http://kinyerezikkkt.or.tz/";
  ...
  static const String SAVE_CHAT_CONVERSATION = BASEURL + "save_user_conversation";
  static const String ONSEEN_USER_CONVERSATION = BASEURL + "on_seen_conversation";
  static const String ON_USER_TYPING = BASEURL + "on_user_typing";
  static const String UPDATE_ONLINE_PRESENCE = BASEURL + "update_user_online_status";
  static const String DELETE_SELECTED_CHATS = BASEURL + "delete_selected_chat_messages";
  static const String CLEAR_USER_CONVERSATION = BASEURL + "clear_user_conversation";
  ...
  //REGISTER MSHARIKA
  static const String REGISTER_MSHARIKA = BASEURL + "registerMsharika";
}
