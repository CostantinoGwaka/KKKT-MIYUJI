      ...
      body: CustomScrollView(
        ...
        slivers: [
          SliverAppBar(
            ...
            expandedHeight:
                (MediaQuery.of(context).size.height * 0.20).clamp(120.0, 220.0),
            floating: false,
            pinned: true,
            elevation: 0,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Level: ${admin.level}', style: TextStyle(fontSize: 12)),
          ...
          child: Column(
            ...
            children: [
              Text('Taarifa za Mzee',
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
              Text('Eneo: ${mzee.eneo}', style: TextStyle(fontSize: 12)),
              Text('Jumuiya: ${mzee.jumuiya}', style: TextStyle(fontSize: 12)),
              Text('Mwaka: ${mzee.mwaka}', style: TextStyle(fontSize: 12)),
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Jumuiya: ${katibu.jumuiya}',
                  style: TextStyle(fontSize: 12)),
              Text('Mwaka: ${katibu.mwaka}', style: TextStyle(fontSize: 12)),
